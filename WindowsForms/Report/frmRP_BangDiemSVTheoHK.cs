...
{
    public partial class frmRP_BangDiemSVTheoHK : Form
    {    
        public frmRP_BangDiemSVTheoHK()
        {
            InitializeComponent();
        }
        ...
        private void crpv_DiemMonHoc_Load(object sender, EventArgs e)
        {
            RP_BangDiemSVTheoHK rp = new RP_BangDiemSVTheoHK();
           ...
           // Ma SV
            ...
            crpv_DiemMonHoc.ReportSource = rp;
            crpv_DiemMonHoc.Refresh();
        }

        private void frmRP_DiemMonHoc_Load(object sender, EventArgs e)
        {
